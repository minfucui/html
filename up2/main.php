...
<head>
    ...
    <script type="text/javascript" src="./js/desktop.js?filever=<?=filesize('js/desktop.js')?>"></script>
    <script type="text/javascript" src="./js/disable_shortcuts_hidden.js"></script>
    <script type="text/javascript" src="./js/shortcut-drawer.js?filever=<?=filesize('js/shortcut-drawer.js')?>"></script>
