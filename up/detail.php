...
<body>
    ...
    <div class="tab-content">
        <div class="show">
            <section class="operation buttonGroup">
                ...
                <button class="file disabled-button" id="file" onclick="openFile()" disabled>日志文件</button>
                ...
                <button class="kill" onclick="toKill()" style="float: right">结束作业</button>
            </section>
    ...
    <script type="text/javascript" src="js/detail.js?filever=<?=filesize('js/detail.js')?>"></script>  <!--方法js-->
</body>
